...
// Clock is the abstraction used by query/windowing logic so that tests
// can run deterministically without sleeping. Production code must never
// call time.Now() directly — take a Clock.
